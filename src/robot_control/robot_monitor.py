...
class SimpleRobotController(Node):
    ...
    def __init__(self):
        ...
        self.create_subscription(Image, '/camera/rgbd/depth/image_raw', self._depth_callback, SENSOR_QOS)
    ...
    def get_display_table(self) -> Table:
        ...
        with self._lock:
            ...
            # Depth camera
            self._add_row(table, "🔲 /camera/rgbd/depth/image_raw", self._sensor_data['depth'])
